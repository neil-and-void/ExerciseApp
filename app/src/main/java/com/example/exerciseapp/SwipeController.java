        ...
        recyclerView.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (swipeBack) {
                    ...
                    // check if item has been swiped far enough to show button
                    if (dX < -buttonWidth) {
                    ...
                    // if button is not in GONE state, overwrite touch listener and simulate click on RecyclerView (because of glitches)
